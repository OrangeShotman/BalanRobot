...
//Y Axis
  ...
  GyroX = GyroX * 0.9 + roll * 0.1;
  GyroY = GyroY * 0.9 + pitch * 0.1;
  //Serial.print("AccPitch = ");Serial.print(pitch);Serial.print(",");Serial.print("AccRoll = ");Serial.print(roll); 
  unsigned char firstDirection=0;
  unsigned char secondDirection=0;
  if(GyroY>=0){
    firstDirection = (unsigned char)GyroY*3;
  }else{
    secondDirection = (unsigned char)-GyroY*3;
  }
  analogWrite(9,firstDirection);
  analogWrite(10,secondDirection);
